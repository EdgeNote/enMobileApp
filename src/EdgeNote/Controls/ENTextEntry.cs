...
using EdgeNote.UI.Delegates;
using Xamarin.Forms;

namespace EdgeNote.UI.Controls
{
    public class ENTextEntry : ContentView
    {
        ...
        public new bool IsEnabled
        {
            ...
            set
            {
                ...
                if (base.IsEnabled)
                {
                    m_txtEntry.BackgroundColor = Color.FromHex(UIConstants.ENTextEntryBackgroundEnabled);
                } else {
                    m_txtEntry.BackgroundColor = Color.FromHex(UIConstants.ENTextEntryBackgroundDisabled);
                }
            }
        }
    }
